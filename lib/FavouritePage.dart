...
class _FavouritepageState extends State<Favouritepage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: (sortedUser.any((user) => user["isFavourite"] == true))
          ? Expanded(
        child: Column(
          children: [
            // Header
              ...
              child: Padding(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return sortedUser[index]['isFavourite'] == true || sortedUser[index]['isFavourite'] == 1
                        ? InkWell(
                      onTap: () {
                                ...
                                children: [
                                  CircleAvatar(
                                    child: Icon(Icons.person,
                                        size: 28, color: Color(0xFF472272)),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      children: [
                                        Text(
                                          sortedUser[index]['name'].length > 20
                                              ? sortedUser[index]['name']
                                              .toString()
                                              .substring(0, 15) +
                                              '...'
                                              : sortedUser[index]['name'],
                                                ...
                                                actions: [
                                                  ElevatedButton(
                                                      onPressed: () async {
                                                        ...
                                                        setState(() {sortedUser[index]['isFavourite'] = false;});
    ...
    //   return Scaffold(
    //   body:(users.any((user) => user["isFavourite"] == true))? Expanded(
    //     child: Column(
    //       children: [
    //         //header
    //         Padding(
