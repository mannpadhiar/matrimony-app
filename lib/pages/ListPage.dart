    ...
    return Scaffold(
      ...
      FutureBuilder(
          ...
          builder: (context, snapshot) {
            ...
            return sortedUser.isEmpty?Center(child: Container(child: Text('No Data',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold,color: Colors.black54),),))
                :Container(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    InkWell(
                                                      onTap: () async {
                                                        if (sortedUser[index]['isFavourite'] == true || sortedUser[index]['isFavourite'] == 1) {
                                                          //for sql
                                                          ...
                                                          // );
                                                          await updateDataFromApi({'isFavourite': false},sortedUser[index]['id']);
                                                          setState(() {
                                                            sortedUser[index]['isFavourite'] = false;
                                                          });
                                                          ...
                                                          // );
                                                          loadAsyncApiData();
                                                          await updateDataFromApi({'isFavourite': true},sortedUser[index]['id']);
                                                          setState(() {
                                                            sortedUser[index]['isFavourite'] = true;
                                                          });
                                                          // await fetchDataFromApi();
                                                        }
                                                        setState(() {
                                                      ...
                                                      child: CircleAvatar(
                                                        ...
                                                        child: Icon(
                                                          sortedUser[index]['isFavourite'] == true ||sortedUser[index]['isFavourite'] == 1
                                                              ? Icons.favorite
                                                  ...
                                                  children: [
                                                    ...
                                                    IconButton(onPressed: (){
                                                      ...
                                                      setState(() {
                                                        ...
                                                        if(sortedUser[index]['isMovies'] == true)isMovies = true;
                                                        if(sortedUser[index]['isDance'] == true)isDance = true;
                                                        if(sortedUser[index]['isDance'] == true)isGames = true;
                                                        if(sortedUser[index]['isMusic'] == true)isMusic = true;
                                                      });
                                                              ...
                                                              actions: [
                                                                ...
                                                                ElevatedButton(
                                                                  onPressed: () async {
                                                                    ...
                                                                    //for api
                                                                    await deleteFromApi(sortedUser[index]['id']);
                                                                    loadAsyncApiData();
                                                                    setState(() {
